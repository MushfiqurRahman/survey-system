<div class="subcategories index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('subtitle_or_code'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($subcategory['Subcategory']['subtitle_or_code']); ?>&nbsp;</td>
		<td><?php echo h($subcategory['Subcategory']['descr']); ?>&nbsp;</td>
		<td><?php echo h($subcategory['Subcategory']['is_optional']); ?>&nbsp;</td>
		<td><?php echo h($subcategory['Subcategory']['status']); ?>&nbsp;</td>
