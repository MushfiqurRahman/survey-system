<div class="outletTypes index">
	<h2><?php echo __('Outlet Types'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $outletType['OutletType']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $outletType['OutletType']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $outletType['OutletType']['id']), null, __('Are you sure you want to delete # %s?', $outletType['OutletType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
